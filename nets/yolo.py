...
def fuse_conv_and_bn(conv, bn):
    # Mix Conv2d + BatchNorm2d reduce the amount of computation
...
class DFL(nn.Module):
    ...
    def forward(self, x):
        ...
        # In the softmax way, the percentage is calculated on the number of 0~16 to obtain the final number.
...
class YoloBody(nn.Module):
    def __init__(self, input_shape, num_classes, phi, pretrained=False):
        ...
        #---------------------------------------------------#   
        #   Generate a backbone model
        #   Three valid feature layers are obtained, and their shapes are respectively：
        #   256, 80, 80
        #   512, 40, 40
        #   1024 * deep_mul, 20, 20
        #---------------------------------------------------#
